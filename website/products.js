const products = [
    // ===== DOG PRODUCTS =====
    { name: "Pedigree Chicken & Vegetables Adult Dog Dry Food", pet: "dog", category: "food", price: 1977, desc: "Complete and balanced dog food for adult dogs with 20% protein", img: "product_images/dog_bed.jpg" },
    ...
    { name: "Dog Harness", pet: "dog", category: "accessories", price: 450, desc: "Padded no-pull comfortable body harness", img: "product_images/dog_bed.jpg" },
    ...
    { name: "Cat Wet Food", pet: "cat", category: "food", price: 50, desc: "Premium canned cat food served in a bowl", img: "product_images/cat_bed.jpg" },
    ...
    { name: "Cat Litter Sand", pet: "cat", category: "accessories", price: 350, desc: "Ultra-clumping odor control sand", img: "product_images/cat_bed.jpg" },
    ...
    // ===== BIRD PRODUCTS =====
    { name: "Bird Seed Mix", pet: "bird", category: "food", price: 400, desc: "Bowl of high-quality mixed bird seeds", img: "product_images/bird_cage.png" },
    { name: "Parrot Food Pellets", pet: "bird", category: "food", price: 350, desc: "Nutrient-rich pellets eaten by a parrot", img: "product_images/bird_cage.png" },
    { name: "Bird Cage", pet: "bird", category: "accessories", price: 1500, desc: "Spacious sturdy cage with bird", img: "product_images/bird_cage.png" },
    ...
    { name: "Bird Water Dispenser", pet: "bird", category: "accessories", price: 120, desc: "Automatic water feeder for bird cage", img: "product_images/bird_cage.png" },
    { name: "Cuttlefish Bone", pet: "bird", category: "accessories", price: 100, desc: "Essential natural calcium supplement", img: "product_images/bird_cage.png" },
    ...
    { name: "Aquarium Tank", pet: "fish", category: "accessories", price: 3400, desc: "Home aquarium tank with beautiful fish", img: "product_images/fish_aquarium_air_pump.jpg" },
    { name: "Aquarium Filter", pet: "fish", category: "accessories", price: 600, desc: "Silent filtration system for fish tank", img: "product_images/fish_aquarium_air_pump.jpg" },
    ...
    { name: "Timothy Hay", pet: "rabbit", category: "food", price: 489, desc: "Rabbit eating high-fiber premium hay", img: "product_images/rabbit_cage.jpg" },
    ...
    { name: "Hamster Wheel", pet: "hamster", category: "accessories", price: 250, desc: "Hamster running in exercise wheel", img: "product_images/hamster_bedding.jpg" },
    ...
    { name: "Pet Grooming Brush", pet: "other", category: "accessories", price: 300, desc: "Brushing dog fur with a brush", img: "product_images/care_first_aid_kit.jpg" },
    ...
    { name: "Pet Travel Carrier", pet: "other", category: "accessories", price: 1200, desc: "Dog inside travel carrier crate", img: "product_images/care_first_aid_kit.jpg" },
    ...
    { name: "Pet Cleaning Wipes", pet: "other", category: "accessories", price: 250, desc: "Cleaning pet paws with wipes", img: "product_images/care_first_aid_kit.jpg" },
];
